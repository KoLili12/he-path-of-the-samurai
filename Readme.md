...
1. **Unit/Integration тесты**
   - PHPUnit для Laravel сервисов
   - Pest для более читаемых тестов
   - Coverage: минимум 80%
...
4. **API Documentation**
   - Swagger/OpenAPI для Rust API
   - Postman коллекции для тестирования

5. **Rust Backend рефакторинг** (planned)
   - Разделение на слои: routes, handlers, services, repos
